...
<html class="no-js">
    ...
    <head>
        ...
        <!-- title -->
        <title>Latest News | POS INDONESIA</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="row">
                                    ...
                                    $sqlselect = "select * from front_post order by post_id desc limit $MulaiAwal , $BatasAwal";
                                        ...
                                        <article class="col-md-4 post">
                                            <div class="postWrapper">
                                                ...
                                                <div class="postContents">
                                                    ...
                                                    <p class="postDetails"><?php
                                                        $ket = $postRow['keterangan'];
                                ...
                                if ($jumlahData > $BatasAwal) {
                                    ...
                                    for ($i = 1; $i <= $c; $i++) {
                                        ...
                                        echo '" href="post_list.php?&hal=' . $i . '">' . $i . '</a>, ';
                                    }
                                    echo '</div></center>';
                                }
                                ?>
                                        ...
                                        <ul id="ticker" class="ticker">
                                            ...
                                            while ($postRow = mysql_fetch_array($data)) {
                                                ...
                                                <li class="clearfix">
                                                    <article class="post">
                                                        <div class="postContents">
                                                            <h5 class="postTitle"><a href="post_view.php?&post_id=<?php echo $postRow['post_id']; ?>" title="post sample"><?php
                                                            $title = $postRow['judul'];
                                                            echo substr($title, 0, 40);
                                                            ?></a></h5>
                                                            <ul class="postMeta">
